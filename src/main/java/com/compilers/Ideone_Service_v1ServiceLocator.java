...
public class Ideone_Service_v1ServiceLocator extends org.apache.axis.client.Service implements com.compilers.Ideone_Service_v1Service {
    ...
    private java.lang.String Ideone_Service_v1Port_address = "http://api.compilers.sphere-engine.com/api/1/service";
    ...
    public com.compilers.Ideone_Service_v1Port getIdeone_Service_v1Port() throws javax.xml.rpc.ServiceException {
    ...
    public com.compilers.Ideone_Service_v1Port getIdeone_Service_v1Port(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
        	com.compilers.Ideone_Service_v1BindingStub _stub = new com.compilers.Ideone_Service_v1BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.compilers.Ideone_Service_v1Port.class.isAssignableFrom(serviceEndpointInterface)) {
            	com.compilers.Ideone_Service_v1BindingStub _stub = new com.compilers.Ideone_Service_v1BindingStub(new java.net.URL(Ideone_Service_v1Port_address), this);
                _stub.setPortName(getIdeone_Service_v1PortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://api.compilers.sphere-engine.com/api/1/service", "Ideone_Service_v1Service");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://api.compilers.sphere-engine.com/api/1/service", "Ideone_Service_v1Port"));
        }
